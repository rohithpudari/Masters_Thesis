...
We base our conclusions on API results, which makes versioning and clarity challenging. We use the current stable Copilot extension release in Visual Studio Code. %The manual effort needed to query Copilot restricts the ability to use large datasets.
