\startchapter{Current Challenges}
...
But these challenges are not surprising, and seem to present straightforward fixes.
...
\input chapters/3/bad_practices
\input chapters/3/common_errors
\input chapters/3/licensing
\input chapters/3/recommendations